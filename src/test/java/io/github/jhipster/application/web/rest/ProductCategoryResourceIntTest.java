...
public class ProductCategoryResourceIntTest {
    ...
    private static final String DEFAULT_TERMS_AND_CONDITIONS_URL = "AAAAAAAAAA";
    private static final String UPDATED_TERMS_AND_CONDITIONS_URL = "BBBBBBBBBB";

    private static final String DEFAULT_DEFAULT_PRODUCT_ID = "AAAAAAAAAA";
    private static final String UPDATED_DEFAULT_PRODUCT_ID = "BBBBBBBBBB";
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory()
            .name(DEFAULT_NAME)
            .termsAndConditionsUrl(DEFAULT_TERMS_AND_CONDITIONS_URL)
            .defaultProductId(DEFAULT_DEFAULT_PRODUCT_ID);
    ...
    public void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getTermsAndConditionsUrl()).isEqualTo(DEFAULT_TERMS_AND_CONDITIONS_URL);
        assertThat(testProductCategory.getDefaultProductId()).isEqualTo(DEFAULT_DEFAULT_PRODUCT_ID);
    }
    ...
    public void getAllProductCategories() throws Exception {
        ...
        restProductCategoryMockMvc.perform(get("/api/product-categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].termsAndConditionsUrl").value(hasItem(DEFAULT_TERMS_AND_CONDITIONS_URL.toString())))
            .andExpect(jsonPath("$.[*].defaultProductId").value(hasItem(DEFAULT_DEFAULT_PRODUCT_ID.toString())));
    }
    ...
    public void getProductCategory() throws Exception {
        ...
        restProductCategoryMockMvc.perform(get("/api/product-categories/{id}", productCategory.getId()))
            ...
            .andExpect(jsonPath("$.termsAndConditionsUrl").value(DEFAULT_TERMS_AND_CONDITIONS_URL.toString()))
            .andExpect(jsonPath("$.defaultProductId").value(DEFAULT_DEFAULT_PRODUCT_ID.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateProductCategory() throws Exception {
        ...
        updatedProductCategory
            .name(UPDATED_NAME)
            .termsAndConditionsUrl(UPDATED_TERMS_AND_CONDITIONS_URL)
            .defaultProductId(UPDATED_DEFAULT_PRODUCT_ID);
        ...
        assertThat(testProductCategory.getTermsAndConditionsUrl()).isEqualTo(UPDATED_TERMS_AND_CONDITIONS_URL);
        assertThat(testProductCategory.getDefaultProductId()).isEqualTo(UPDATED_DEFAULT_PRODUCT_ID);
    }
